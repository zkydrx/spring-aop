package com.zkyking.springaop.utils;

import com.zkyking.springaop.config.model.JwtConstants;
...
public class JwtUtils
{
    ...
    public static String generateToken(UserInfo userInfo, PrivateKey privateKey, int expireMinutes)
    {
        ...
        return Jwts.builder()
                   ...
                   .claim(JwtConstants.JWT_KEY_USER_TYPE, userInfo.getType())
    ...
    public static UserInfo getUserInfo(PublicKey publicKey, String token)
    {
        ...
        return new UserInfo(ObjectUtils.toLong(body.get(JwtConstants.JWT_KEY_ID)),
                            ObjectUtils.toString(body.get(JwtConstants.JWT_KEY_USER_NAME)),
                            ObjectUtils.toString(body.get(JwtConstants.JWT_KEY_USER_TYPE)));
    }
