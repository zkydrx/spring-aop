...
@MapperScan(value = {"com.zkyking.springaop.db.mapper"}, sqlSessionFactoryRef = "sqlSessionFactory")
...
public class DbOneDruidDataSourceConfiguration
{
    ...
    @Primary
    public SqlSessionFactory dbOneSqlSessionFactory(@Qualifier("druidDataSource") DruidDataSource druidDataSource) throws Exception
    {
